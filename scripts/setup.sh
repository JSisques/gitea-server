...
# Paso 5: Ejecutar Docker Compose para iniciar el servidor de Gitea
echo "Paso 5: Iniciando el servidor de Gitea con Docker Compose..."
docker-compose up -d
echo "El servidor de Gitea se está ejecutando en segundo plano."